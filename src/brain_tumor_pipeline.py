...
TUMOR_GRADES = {
    "glioma": {"grade": "II-IV", "description": "Aggressive", "risk": "High"},
    "meningioma": {"grade": "I-II", "description": "Usually benign", "risk": "Low-Moderate"},
    "pituitary": {"grade": "I", "description": "Benign adenoma", "risk": "Low"},
}

print("=" * 60)
print("  Brain Tumor Detection & Grading Pipeline")
print("=" * 60)
...
plt.suptitle("ResNet18 Training History - Brain Tumor MRI", fontweight="bold")
plt.tight_layout()
...
results = {
    ...
    "dataset": "Brain Tumor MRI (PranomVignesh/MRI-Images-of-Brain-Tumor)",
...
print(f"  Best epoch:         epoch {train_accs.index(max(train_accs))+1}")
print(f"  Classification:     {' | '.join(CLASS_NAMES)}")
print(f"  Grading:            Glioma (II-IV) | Meningioma (I-II) | Pituitary (I)")
